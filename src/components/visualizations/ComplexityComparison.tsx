 ...
 *   - Centered container with auto-height and zero text truncation.
 */
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-1 mb-1">
                <span className={`text-[10px] sm:text-[11px] font-bold ${isSelfAttention ? 'text-apple-blue' : 'text-apple-text'}`}>
                  {row.layerType}
                </span>
